//
//  HomeDeliveryOrderObject+Reflectable+Validatable.swift
//  App
//
...
/// # Extension for the HomeDeliveryOrderObject to make it conform to Validatable and Reflectable.
...
extension HomeDeliveryOrderObject: Validatable, Reflectable {
    
    static func validations() throws -> Validations<HomeDeliveryOrderObject> { // 1
        
        var validations = Validations(HomeDeliveryOrderObject.self) // 2
